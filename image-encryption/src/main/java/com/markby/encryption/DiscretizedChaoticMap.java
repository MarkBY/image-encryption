...
public class DiscretizedChaoticMap {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 8; i++) {
            k2 = mTransformation(k1);
            int[][] data = ImageUtils.getRandomData(m, n, 2021421);
            k2 = aTransformation(k2, data);
            k2 = sTransformation(k2);
            k2 = kTransformation(k2, s);
        }

        k2 = mTransformation(k2);
        int[][] data1 = ImageUtils.getRandomData(m, n, 2021421);
        k2 = aTransformation(k2, data1);
        k2 = kTransformation(k2, s);
